...
- [`sector_plan_search_metadata.csv`](<graph data/sector_plan_search_metadata.csv>) has one row per OCR-readable plan document, with title, country, year, language, source links, and text length.
